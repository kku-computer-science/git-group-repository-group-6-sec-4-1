    ...
    <div class="mb-3">
        <form method="GET" action="{{ url('/logs') }}" class="d-flex gap-3 align-items-end" id="activityFilterForm">
            ...
            <div class="form-group">
                ...
                <input type="date" name="start_date" id="start_date" class="form-control" value="{{ $selected_start_date ?? request('start_date') }}">
            </div>

            <div class="form-group">
                <label for="end_date">End Date:</label>
                <input type="date" name="end_date" id="end_date" class="form-control" value="{{ $selected_end_date ?? request('end_date') }}">
            </div>
    ...
    <div class="mb-3">
        <form method="GET" action="{{ url('/logs/http') }}" class="d-flex gap-3 align-items-end" id="httpFilterForm">
            ...
            <div class="form-group">
                ...
                <input type="date" name="start_date" id="http_start_date" class="form-control" value="{{ $selected_start_date ?? request('start_date') }}">
            </div>
            <div class="form-group">
                <label for="http_end_date">End Date:</label>
                <input type="date" name="end_date" id="http_end_date" class="form-control" value="{{ $selected_end_date ?? request('end_date') }}">
            </div>
            <button type="submit" class="btn btn-primary">Filter</button>
