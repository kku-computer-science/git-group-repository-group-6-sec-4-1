...
จากนั้นสร้างไฟล์ .env ที่ Root folder และทำการคัดลอกข้อมูลจากไฟล์ [.env.example](https://github.com/kku-computer-science/git-group-repository-group-6-sec-4-1/blob/suchaya_2169/.env.example)   จากนั้นทำการติดตั้งฐานข้อมูล    ![โดยการเปิดใช้งาน xampp และไปที่เมนู Admin ของ Mysql](https://github.com/user-attachments/assets/583dec89-c949-4ec1-9f97-90d8d003ccb0) 
